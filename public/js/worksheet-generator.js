...
const WORKSHEET_PHRASE_MAP = {
    ...
    'Generated by VED-AI Visualizer': {
        'zh-Hant': '由 VED-AI Visualizer 生成',
        fr: 'Genere par VED-AI Visualizer',
        ru: 'Сгенерировано в VED-AI Visualizer',
        fa: 'تولید شده توسط VED-AI Visualizer',
        ur: 'VED-AI Visualizer کی جانب سے تیار کردہ',
        tl: 'Nabuo ng VED-AI Visualizer'
    }
};
...
function renderWorksheet(worksheet, mode) {
    ...
    html += `
            <div class="worksheet-footer">
                <span>${tr('Generated by VED-AI Visualizer', '由 VED-AI Visualizer 生成')}</span>
            </div>
        </div>
    `;
...
function exportToPDF() {
    ...
    const title = tr('VED-AI Visualizer — Balancing Chemical Equations Worksheet', 'VED-AI Visualizer — 化学方程式配平练习');
        ...
        <tbody>
            <tr>
                <td class="print-content">
                    ...
                    <div class="doc-footer">Generated by VED-AI Visualizer</div>
