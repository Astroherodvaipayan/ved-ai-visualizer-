// =============================================================================
// Language Controller — global i18n for EN / HI / KN / TA / TE (Indian languages)
// =============================================================================

import { translations } from "../data/translations.js";

const STORAGE_KEY = "vedai_lang";
...
const ELEMENT_LOCALE_LOADERS = {
  // Indian languages - for future implementation
  // Currently using English names for elements
  hi: null,
  kn: null,
  ta: null,
  te: null,
...
const ION_LOCALE_LOADERS = {
  // Indian languages - for future implementation
  // Currently using English names for ions
  hi: null,
  kn: null,
  ta: null,
  te: null,
...
export function initLangController() {
  ...
  if (sessionStorage.getItem("vedai_lang_transition") === "true") {
    sessionStorage.removeItem("vedai_lang_transition");
    const overlay = document.createElement("div");
    overlay.style.position = "fixed";
    overlay.style.top = "0";
    overlay.style.left = "0";
