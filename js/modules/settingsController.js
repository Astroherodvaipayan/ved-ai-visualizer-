...
// renderChangelog function removed
...
function initSettingsSuggestionForm() {
  ...
  const sendSuggestion = async () => {
    ...
    await submitSuggestion(text, { source: "VED-AI Visualizer Settings" });
